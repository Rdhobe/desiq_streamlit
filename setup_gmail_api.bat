@echo off
echo DesiQ Gmail API Setup Tool
echo =========================
echo.
...
if %errorlevel% neq 0 (
    ...
    echo 1. Make sure you've added exactly http://localhost:8080/ to your OAuth client's redirect URIs
    echo 2. See OAUTH_REDIRECT_URI_FIX.md for detailed instructions
    echo.
    echo For more information, see GMAIL_API_SETUP.md
)
